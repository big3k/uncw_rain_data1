...
!        nscans = 2328 ;
      ...
      integer  :: nchannel,  nfovs, nscans, ngroups
      ...
      character(len=1064) :: nchannel_name, nfovs_name, nscans_name, ngroups_name 
      ...
      real*4, allocatable ::  BeamLatitude(:, :, :), BeamLongitude(:, :, :) 
      ...
      call check(nf90_inquire_dimension(ncid,4, ngroups_name, ngroups) )

      write(*, *) trim(nchannel_name), "=",  nchannel, &
                  trim(nfovs_name), "=", nfovs,  & 
                  trim(nscans_name), "=", nscans, & 
                  trim(ngroups_name), "=", ngroups  
      ...
      allocate(BeamLatitude(ngroups, nfovs, nscans) )
      allocate(BeamLongitude(ngroups, nfovs, nscans) )
      ...
      deallocate(lon) 
      deallocate(BeamTime) 
      deallocate(AD_Indicator) 
      deallocate(SatelliteZenithAngle) 
      deallocate(SolarZenithAngle) 
      deallocate(BeamLatitude) 
      deallocate(BeamLongitude) 
