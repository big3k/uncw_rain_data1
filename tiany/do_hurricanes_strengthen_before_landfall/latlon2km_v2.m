function d1km=latlon2km(latlon1,latlon2)
%04/02/2018 
% this program is vectorized
% the first variable is the 1*2 (lat, lon)
% the second variable is N*2
...
radius=6374; %average is 6374 km of earth radius
