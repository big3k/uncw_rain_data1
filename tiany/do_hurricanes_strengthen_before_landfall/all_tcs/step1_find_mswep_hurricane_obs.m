%YDT2 8/28/2028: dump the entire lifespan of the selected TCs, instead of 60 hours before landfall.  
...
data_loc='/data1/tiany/do_hurricanes_strengthen_before_landfall/all_tcs/step0/'; 
save_fig_loc='/data1/tiany/do_hurricanes_strengthen_before_landfall/all_tcs/step1-data-mswep/';
    ...
    for ijk=1:length(filelist_hur)
      ...
      %YDT  end
       ...
       % keyboard
        ...
        %YDT2 8/28/2026: Here landfall time is set as the end of the storm 
        ...
        for k1=1:length(time1)
            ...
            %YDT2 if landfall_prior_time(k1)>=-60 & landfall_prior_time(k1)<=0
            %YDT2: do all lifetime
            if  landfall_prior_time(k1)<=0
