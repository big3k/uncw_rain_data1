...
save_loc = ...
    '/data1/tiany/do_hurricanes_strengthen_before_landfall/all_tcs/step0/'; 
%    '/data1/youy/project/trend-landfall/data/step0/';

%% =========================================================
% Read IBTrACS
% every var's dimension is (storm, date_time) = (13559, 360) 
% ==========================================================
lon       = ncread(FN,'lon');
lat       = ncread(FN,'lat');
...
for i = 1:nstorm
    ...
    %YDT: pick only storms that crossed 25N
    %YDT2 ix_landfall = ...
    %YDT2      xLAT > 25 & ...
    %YDT2      ix_scale & ...
    %YDT2      ix_tropical;

    %YDT2: pick every Tropical 
    ix_landfall =  ix_scale & ix_tropical;
    ...
    %YDT2 start_time     = date3(1);
    %YDT2 start_landfall = date3(J1);

    %% -----------------------------------------------------
    % YDT2: save entire life of strom 
    % ------------------------------------------------------
    J1 = find(~isnan(date3), 1, 'last') % end of storm 
    ...
    fprintf( ...
        ['SELECTED: %4d  %-15s  %-15s  ', ...
         ...
         'Pre-LF (now whole lifespan) = %.1f h\n'], ...
        jsq, ...
        A, ...
        SID, ...
