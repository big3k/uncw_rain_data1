...
for ijk1=1:length(YR)
     ...
     fid22_xx=fopen([save_loc,'imerg-rainrate-upto500km','-',num2str(YR(ijk1)),'-xx-ir.dat'],'w');
     fid22_yy=fopen([save_loc,'imerg-rainrate-upto500km','-',num2str(YR(ijk1)),'-yy-ir.dat'],'w');
     fid22_loc=fopen([save_loc,'imerg-rainrate-upto500km','-',num2str(YR(ijk1)),'-loc-ir.dat'],'w');
