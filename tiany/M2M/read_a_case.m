...
% locate the case
% s_name is one of ["noaa18", "noaa19", "metopa", "metopb", "npp"]
s_name='noaa19'; % sourder name
...
outf=strcat(s_name, '_', NianYue, '_', case_name, '.mat'); 
...
% The second value is between GMI and the adjusted N19 (i.e., corr(sate_select.a2,sate_select.c2)).
        ...
        data_loc2=[data_loc,NianYue,'/',case_name, '/'];
