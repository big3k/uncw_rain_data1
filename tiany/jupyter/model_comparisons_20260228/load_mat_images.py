...
def load_dataset(batch_size=16, fullset=True, height=101, width=101):
   ...
   # new path, found the old path contains unequal number of gmi/ssmis cases as of 20260228 
   path='/data1/youy/tropics-hurricane/figure/cat1-cat5-tropics-gpm-update-filter-super-reso-v2/version1-20250724/'
   if fullset: 
